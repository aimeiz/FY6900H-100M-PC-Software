...
namespace FY6900H_100M_PC_Software
{
    ...
    public partial class Form1 : Form
    {
        ...
        public static void readParameters()
        {
            ...
            int auxWave = int.Parse(Parameters.auxWaveForm);
            if (auxWave > 4) { auxWave += 1; Parameters.auxWaveForm = auxWave.ToString(); } //Patch to firmware bug
        ...
        public void displayParameters()
        {
            ...
            if (mainWaveForm.Text != waveConvert(Parameters.mainWaveForm)) mainWaveForm.Text = waveConvert(Parameters.mainWaveForm);
            ...
            if (auxWaveForm.Text != waveConvert(Parameters.auxWaveForm)) auxWaveForm.Text = waveConvert(Parameters.auxWaveForm);
            //auxWaveForm.Text = Parameters.auxWaveForm;
